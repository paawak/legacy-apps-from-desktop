...
public class InvoiceController implements TableListDB, InvoiceDB, ClientAccountDB{
    ...
    public Object[] getClientNames(String frmDate, String toDate){
        Object[] obj = null;        
        try{
            String where="WHERE "+InvoiceDB.invoicedate+">='"+frmDate+"' AND "+InvoiceDB.invoicedate+"<='"+toDate+"'";
            obj = invDB.queryOneColumn(InvoiceDB.accnum,true,where+" ORDER BY "+InvoiceDB.accnum);
        }catch(Exception e){
        }          
    ...
    public Object[] getInvoiceNums(String frmDate, String toDate){
        ...
        try{
            String where="WHERE "+InvoiceDB.invoicedate+">='"+frmDate+"' AND "+InvoiceDB.invoicedate+"<='"+toDate+"'";
            obj = invDB.queryOneColumn(InvoiceDB.invoicenum,true,where+" ORDER BY "+InvoiceDB.invoicenum);
        }catch(Exception e){
        }        
        return obj;
    }
     ...
     */
    public Object[] getInvoiceNums(String frmDate, String toDate, Object clientName){
        ...
        Object[] obj = null;
        try{
            String where="WHERE "+InvoiceDB.invoicedate+">='"+frmDate+"' AND "+InvoiceDB.invoicedate+"<='"+toDate+"' AND "+InvoiceDB.accnum+"='"+clientAcc+"'";
            obj = invDB.queryOneColumn(InvoiceDB.invoicenum,true,where+" ORDER BY "+InvoiceDB.invoicenum);
        }catch(Exception e){
        }        
        return obj;
    ...
    /**
     *gets the records based on an invoice number
     *returns an instance of InvoiceObject
     */
    public InvoiceObject getInvoiceRecord(Object invNum){
        InvoiceObject obj = null;
        try{
            String where = "WHERE "+InvoiceDB.invoicenum+"='"+invNum+"'";
            obj = new InvoiceObject(invDB.queryMultipleElements(invDB.getColumnNames(),where));
    ...
    public  boolean updateBookAdj(Object[] obj,Object invNum){
        try{
            String where = "WHERE "+InvoiceDB.invoicenum+"='"+invNum+"'";
            return invDB.updateData(new String[]{InvoiceDB.bookadjamt,InvoiceDB.remarks,InvoiceDB.netreceivable,InvoiceDB.recievedamt,InvoiceDB.ispartpayment,InvoiceDB.haspaidfull,InvoiceDB.employeeid,InvoiceDB.entrydate,InvoiceDB.entrytime},obj,where);
        }catch(Exception e){
