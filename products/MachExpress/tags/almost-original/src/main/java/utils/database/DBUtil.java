...
public  abstract class DBUtil extends javax.swing.JFrame {
    ...
    /**
     *holds the database vendor name: "mysqlJdbcClass4Driver" by default
     *can be set to "postgresJdbcDriverClass3" for using postgres with class 3
     *jdbc driver
     *can be set to "jdbcOdbcDriver" for using jdbc odbc driver
     */
    ...
    /**
     *holds the characters requiring escape character before them, in order to be saved in the database.
     *for example, mysql doesnot store ', " and \ characters unless they are preceeded by the escape character \
     *i.e., \', \", \\, etc.
     */
     ...
     *public final  DBUtil(String DatabaseName, String DatabaseUserName, String DatabasePassword, String DatabaseTableName)
     *this is the default constructor and connects to a mysql database
     *using mysql jdbc class 4 driver
     */
    public  DBUtil(String DatabaseName, String userName, String password, String tableName, boolean displayErrors, String[] charsWithEscapeSeq) {        
     ...
     *
     *Creates a new instance of DBUtil:
     *the type of connection here can be set:
     *for jdbc:odbc driver, Driver="jdbcOdbcDriver"
     *for postgres:jdbc classs3  driver, Driver="postgresJdbcClass3Driver"
     *for mysql:jdbc classs4  driver, Driver="mysqlJdbcClass4Driver"
     */
    public  DBUtil(String DatabaseName, String userName, String password, String tableName, boolean displayErrors, String[] charsWithEscapeSeq,String Driver) {        
        this.DatabaseName=DatabaseName;
        this.userName = userName;
        this.password = password; 
        this.tableName=tableName;  
     ...
     *this method uses the native jdbc-odbc driver
     *
     */
    ...
    if(Driver.equalsIgnoreCase("mysqlJdbcClass4Driver")){
        ...
        try{
            ...
            if(userName.trim().equals("")||password.trim().equals(""))
                ...
                con=DriverManager.getConnection("jdbc:odbc:"+DatabaseName,userName,password);
    ...
    /**
     *Convinience method to connect to the Database
     *this method uses the MySql-JDBC class 4 driver
     *To use the MySQL Class1 JDBC driver, place the mysql-connector-java-3.0.10-stable-bin.jar
     *in $JAVA_HOME/jre/lib/ext.
     *the user name is the linux login name, password is not required, so it should be blank
     */
    private final void accessDB_mysqlJdbcClass4Driver(String DatabaseName, String userName, String password){
        
        try{
        
        Class.forName("com.mysql.jdbc.Driver").newInstance();
        
        con = DriverManager.getConnection("jdbc:mysql://localhost/"+DatabaseName+"?user="+userName+"&password="+password);
    ...
    /**
     *method to access a postgres database
     *for jdbc to connect to postgres databse, use the -i option while starting the postmaster
     *so that it accepts TCP/IP connection, otherwise, connection is refused
     *use the follwing command while start up:
     *postmaster -D /usr/local/pgsql/data -i
     *postgres driver used: pg74jdbc3.jar, which means it is CLASS 3 type of jdbc driver
     */
    private final void accessDB_postgresJdbcClass3Driver(String DatabaseName, String userName, String password){
     ...
     *public final  void executeSQLStatement(String SQL-Statement)throws java.sql.SQLException
     *
     */
     ...
     *it returns the SQL-Statement as String.
     *public final  String getInsertStatement(String[] ColumnNames, Object[] Values)
     *
     */
    public final  String getInsertStatement(String[] col_Names, Object[] val) {
        ...
        if(col_Names.length!= val.length)
            JOptionPane.showMessageDialog(this," Value-List not matching with the no. of Columns.No. of columns = "+col_Names.length+"\tNo. of values to be inserted = "+val.length+": Make sure that they are equal.","Error in DBUtil_01.getInsertStatement() using table "+tableName+":",JOptionPane.ERROR_MESSAGE);
        else{
     ...
     *it returns the SQL-Statement as String.
     *public final  String getUpdateStatement(String[] ColumnNames, Object[] Values, String WhereCondition)
     *
     */    
    public final  String getUpdateStatement(String[] col_Names, Object[] val, String whereClause) {
        ...
        if(col_Names.length!= val.length )
            JOptionPane.showMessageDialog(this," Value-List not matching with the no. of Columns.No. of columns = "+col_Names.length+"\tNo. of values to be inserted = "+val.length+": Make sure that they are equal.","Error in the modifyData method of LinkDB class using Database Table "+tableName+":",JOptionPane.ERROR_MESSAGE);
        else{//main else
    ...
    /**
     *Method to insert data into a database table. Returns true if INSERTion is successful
     *else returns false.
     *public final  String insertData(String[] ColumnNames, Object[] Values)
     *
     */
    ...
    /**
     *Method to QUERY a single column from a database table: 
     *public final  Object[] queryOneColumn(String ColumnNameToBeQueried, boolean RowsDistinct, String WhereCondition)throws Exception 
     *
     */
    ...
    /**
     *Method to QUERY all the columns from a database table:
     *public final  Object[][] queryAllColumns(boolean RowsDistinct, String WhereCondition)throws Exception 
     *
     */    
    ...
    /**
     *Method to QUERY more than one columns from a database table:
     *public final  Object[][] queryMultipleColumns(String[] ColumnNames, boolean RowsDistinct,String WhereCondition)throws Exception 
     *
     */      
    ...
    /**
     *Method to QUERY more than one columns from a database table, but which comes in a single row: 
     *public final  Object[] queryMultipleElements(String[] ColumnNames, String WhereCondition)throws Exception 
     *
     */       
    ...
    /**
     *Method to QUERY one element from a database table:
     *public final  Object queryOneElement(String ColumnName, String WhereCondition)throws Exception 
     *
     */      
    ...
    /**
     *Method to QUERY the no. of rows in a database table:
     *public final  int queryRows(String WhereCondition,boolean RowsDistinct)throws Exception
     *
     */        
    ...
    /**
     *Method to update data into a database table. Returns true if UPDATion is successful
     *else returns false.
     *public final  String updateData(String[] ColumnNames, Object[] Values, String WhereCondition)
     *
     */    
    ...
    /**
     *utility to check for the characters in charsWithEscapeSeq array in the input Object and replace them with
