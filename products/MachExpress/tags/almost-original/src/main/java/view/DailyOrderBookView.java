...
public class DailyOrderBookView extends javax.swing.JPanel implements
    ...
    /**
     *to fill cbCustName combo with new elements. it removes the old elements
     * if any
     */
    ...
    /**
     *to fill cbDestination combo with new elements. it removes the old
     * elements if any
     */
    ...
    /**
     *to set the decimal & number fields to 0 and date/time to current date
     * time
     */
    ...
    /**
     * finds out the current search criteria chosen by the user: inv num/cust
     * name and takes appropriate action
     * 
     */
    ...
    /**
     * displays the given invoice according to the selected item in the invoice
     * num combo
     * 
     */
    ...
    /**
     * to set the txtFromDate to the 1st of the month and txtToDate to the
     * current date
     * 
     * 
     */
    ...
    /**
     *it holds the consignment no. for modificatiom: in modify mode, u can
     * modify the consignment no. but need the old value to update the record
     */
