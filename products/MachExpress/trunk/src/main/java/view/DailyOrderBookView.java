...
public class DailyOrderBookView extends javax.swing.JPanel implements TableListDB, ClientAccountDB, DailyOrderBookDB {
    ...
    private void initComponents() {
        ...
        add(lbConsignmentNum, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 140, -1, -1));

        add(txtConsignmentNum, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 140, 270, -1));

        lbAccNum.setText("Customer Name :");
        add(lbAccNum, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 170, 140, -1));
        ...
        add(cbCustName, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 170, 270, -1));

        lbDestination.setText("Destination :");
        add(lbDestination, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 220, 130, -1));

        lbWeight.setText("Weight :");
        add(lbWeight, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 270, 120, -1));

        lbPackets.setText("No. of packets :");
        add(lbPackets, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 320, 90, -1));

        lbAmount.setText("Amount :");
        add(lbAmount, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 380, 50, -1));

        lbTransactionType.setText("Transaction type :");
        add(lbTransactionType, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 430, -1, -1));

        lbDeliveryDate.setText("Delivery Date :");
        add(lbDeliveryDate, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 490, -1, -1));

        lbDeliveryTime.setText("Delivery Time :");
        add(lbDeliveryTime, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 530, -1, -1));
        ...
        add(txtWeightKg, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 270, 70, -1));
        ...
        add(txtPackets, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 320, 70, -1));
        ...
        add(txtAmount, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 380, 260, -1));
        ...
        add(txtDeliveryDate, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 490, 270, -1));

        add(txtDeliveryTime, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 530, 270, -1));

        lbKg.setText("Kg");
        add(lbKg, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 270, -1, -1));

        lbConsignmentTime.setText("Consignment Time :");
        add(lbConsignmentTime, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 110, -1, -1));

        add(txtConsignmentTime, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 100, 270, -1));
        ...
        add(txtWeightGm, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 270, 70, -1));

        lbGm.setText("gm");
        add(lbGm, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 270, -1, -1));
        ...
        add(txtConsignmentDate, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 70, 135, -1));

        lbConsignmentDate.setText("Consignment Date :");
        add(lbConsignmentDate, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 80, -1, -1));
        ...
        add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 320, -1, -1));

        add(cbType, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 320, 160, -1));
        ...
        pnlAddMode.add(btSave, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 20, -1, -1));
        ...
        pnlAddMode.add(btDone, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 20, -1, -1));

        add(pnlAddMode, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 590, 400, 60));
        ...
        pnlModifyMode.add(btSaveChanges, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 20, -1, -1));
        ...
        pnlModifyMode.add(btDelete, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 20, -1, -1));
        ...
        pnlModifyMode.add(btClose, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 20, -1, -1));

        add(pnlModifyMode, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 590, 480, 70));

        jLabel3.setText("YYYY/MM/DD");
        add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 70, -1, -1));

        jLabel4.setText("HH:mm:ss");
        add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 100, -1, -1));

        jLabel5.setText("HH:mm:ss");
        add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 530, -1, -1));

        jLabel6.setText("YYYY/MM/DD");
        add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 490, -1, -1));
        ...
        add(scrPnAmountList, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 400, 260, 80));
        ...
        pnlRadioBts.add(rdBtCash, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 10, -1, -1));

        btnGrpTransactionType.add(rdBtCredit);
        rdBtCredit.setSelected(true);
        rdBtCredit.setText("Credit");
        pnlRadioBts.add(rdBtCredit, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 10, -1, -1));

        add(pnlRadioBts, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 420, 260, 50));

        pnlBulkOrder.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        pnlBulkOrder.setVisible(false);
        jLabel8.setText("To :");
        pnlBulkOrder.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 0, -1, -1));
        ...
        pnlBulkOrder.add(txtConsignmentNumFrom, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 0, 60, -1));

        jLabel9.setText("From :");
        pnlBulkOrder.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, -1, -1));
        ...
        pnlBulkOrder.add(txtConsignmentNumTo, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 0, 60, -1));

        add(pnlBulkOrder, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 140, 310, 50));

        cbDestination.setEditable(true);
        fillDestinationCombo();
        add(cbDestination, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 220, 270, -1));

        pnlSearchMain.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        pnlSearchMain.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Search:", javax.swing.border.TitledBorder.LEFT, javax.swing.border.TitledBorder.DEFAULT_POSITION));
        ...
        pnlSearchMain.add(btDeleteRecords, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 530, -1, -1));
        ...
        pnlSearchMain.add(rdBtConsignmentNum, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 110, -1, -1));
        ...
        pnlSearchMain.add(rdBtClientName, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 110, -1, -1));
        ...
        pnlSearchByClientName.add(cbCustNameSearch, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 10, 250, -1));

        pnlSearchMain.add(pnlSearchByClientName, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 140, 440, 40));

        pnlSearchByConsNum.setLayout(new java.awt.BorderLayout());

        pnlSearchMain.add(pnlSearchByConsNum, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 220, 300, 280));

        jLabel2.setText("Consignment Numbers :");
        pnlSearchMain.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 190, 180, -1));

        add(pnlSearchMain, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 70, 520, 610));
        ...
        add(pnlBulkOrderTitle, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 30, 440, 30));

        btDateBackward.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/backward.JPG")));
        ...
        add(btDateBackward, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 70, 24, 20));

        btDateForward.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/forward.JPG")));
        ...
        add(btDateForward, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 70, 24, 20));

    }// </editor-fold>//GEN-END:initComponents
    
    private void btDateBackwardMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btDateBackwardMouseReleased
        // Add your handling code here:
        txtConsignmentDate.setText(getPrevBackDate(txtConsignmentDate.getText(),-1));
    }//GEN-LAST:event_btDateBackwardMouseReleased
    
    private void btDateForwardMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btDateForwardMouseReleased
        // Add your handling code here:
        txtConsignmentDate.setText(getPrevBackDate(txtConsignmentDate.getText(),1));
    }//GEN-LAST:event_btDateForwardMouseReleased
    
    private void cbCustNameItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cbCustNameItemStateChanged
        // Add your handling code here:
        cbCustName.setToolTipText(cbCustName.getSelectedItem().toString());
    }//GEN-LAST:event_cbCustNameItemStateChanged
    
    private void lstAmountKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_lstAmountKeyReleased
        // Add your handling code here:
    ...
    private void txtConsignmentNumToFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtConsignmentNumToFocusGained
        // Add your handling code here:
        txtConsignmentNumTo.selectAll();
    }//GEN-LAST:event_txtConsignmentNumToFocusGained
    
    private void txtConsignmentNumFromFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtConsignmentNumFromFocusGained
        // Add your handling code here:
        txtConsignmentNumFrom.selectAll();
    }//GEN-LAST:event_txtConsignmentNumFromFocusGained
    
    private void rdBtConsignmentNumMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_rdBtConsignmentNumMouseReleased
        // Add your handling code here:
        findSearchCriteria();
    ...
    private void btDeleteRecordsMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btDeleteRecordsMouseReleased
        // Add your handling code here:
        ...
        int opt = JOptionPane.showConfirmDialog(this,"You are about to delete " + consignmentNos.length + " record(s) permanently. Are you sure?","Confirm delete",JOptionPane.YES_NO_OPTION);
        if(opt==JOptionPane.YES_OPTION){//user chooses to delete
            ...
            for(int i=0; i<consignmentNos.length; i++){
                if(!dailyOrderBookController.deleteRecord(consignmentNos[i])){
                    recordsDeleted --;
                    JOptionPane.showMessageDialog(this,"Record could not be deleted: Consignment No.: " + consignmentNos[i],"Could not delete record...",JOptionPane.ERROR_MESSAGE);
                }
            }
            if(recordsDeleted > 0){
                JOptionPane.showMessageDialog(this,recordsDeleted + " Record(s) deleted successfully","Delete successful",JOptionPane.INFORMATION_MESSAGE);                
                MachExpressFrame.INSTANCE.showDailyOrderBookModify();
            }
        }
    }//GEN-LAST:event_btDeleteRecordsMouseReleased
    
    private void cbCustNameSearchItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cbCustNameSearchItemStateChanged
        // Add your handling code here:
        //fill cbInvoiceNum
        Object[] obj2 = dailyOrderBookController.getConsignmentNums(txtFromDate.getText(),txtToDate.getText(),cbCustNameSearch.getSelectedItem());
    ...
    private void txtConsignmentNumToFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtConsignmentNumToFocusLost
        // Add your handling code here:
    ...
    private void txtConsignmentNumFromFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtConsignmentNumFromFocusLost
        // Add your handling code here:
    ...
    private void txtDeliveryDateFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtDeliveryDateFocusGained
        // Add your handling code here:
        hidePriceList();
    }//GEN-LAST:event_txtDeliveryDateFocusGained
    
    private void lstAmountValueChanged(javax.swing.event.ListSelectionEvent evt) {//GEN-FIRST:event_lstAmountValueChanged
        // Add your handling code here:
        amtListItemSelected();
    }//GEN-LAST:event_lstAmountValueChanged
    
    private void lstAmountMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lstAmountMouseReleased
        // Add your handling code here:
        amtListItemSelected();
    ...
    private void lstAmountFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_lstAmountFocusLost
        // Add your handling code here:
        hidePriceList();
    ...
    private void txtWeightGmFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtWeightGmFocusLost
        // Add your handling code here:
    ...
    private void txtWeightKgFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtWeightKgFocusLost
        // Add your handling code here:
    ...
    private void txtPacketsFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtPacketsFocusGained
        // Add your handling code here:
        txtPackets.selectAll();
    }//GEN-LAST:event_txtPacketsFocusGained
    
    private void txtWeightGmFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtWeightGmFocusGained
        // Add your handling code here:
        txtWeightGm.selectAll();
    }//GEN-LAST:event_txtWeightGmFocusGained
    
    private void txtWeightKgFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtWeightKgFocusGained
        // Add your handling code here:
    ...
    private void txtConsignmentDateMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_txtConsignmentDateMouseReleased
        // Add your handling code here:
        new ShowCalendar(new java.awt.Frame(), true,  txtConsignmentDate).show();
    }//GEN-LAST:event_txtConsignmentDateMouseReleased
    
    /**
     *sets some of the fields invisible so that new data can
     *be entered
     */
    public void setFormToAdd(){
        ...
        /*lbDeliveryDate.setVisible(false);
        txtDeliveryDate.setVisible(false);
    ...
    public void setFormToModify(){
        ...
        //remove mouse listener from consignment date so that user cannot modify
        ...
        srchPnl = new SearchPanel_NoButton(dailyOrderBookController.getConsignmentNums(txtFromDate.getText(),txtToDate.getText()) );
            ...
            public void mouseClicked(MouseEvent me){
                if(me.getClickCount() == 2){
                    ...
                    if(srchPnl.listSearch.getSelectedValue() != null)
                        displayRecordFromList(srchPnl.listSearch.getSelectedValue().toString());
                }
            }
        });
    ...
    /**
     *to fill cbCustName combo with new elements.
     *it removes the old elements if any
     */
    ...
    /**
     *to fill cbDestination combo with new elements.
     *it removes the old elements if any
     */
    private void fillDestinationCombo(){
        JComboUtils.fillComboWithNewArray(cbDestination, dailyOrderBookController.getDestinationArr());
    }
    
    /**
     *to set the decimal & number fields to 0
     *and date/time to current date time
     */
    ...
    private boolean isDataValid() {
        if(txtConsignmentDate.getText().trim().equals("")){
            JOptionPane.showMessageDialog(this,"Please enter the Consignment Date.","'Consignment Date' is vacant:",JOptionPane.INFORMATION_MESSAGE);
            txtConsignmentDate.requestFocus();
            return false;
        } else if(txtConsignmentNum.getText().trim().equals("")){
            JOptionPane.showMessageDialog(this,"Please enter the Consignment Number.","'Consignment Number' is vacant:",JOptionPane.INFORMATION_MESSAGE);
            txtConsignmentNum.requestFocus();
            return false;
        } else if(cbDestination.getSelectedItem().toString().trim().equals("")){
            JOptionPane.showMessageDialog(this,"Please enter the Destination.","'Destination' is vacant:",JOptionPane.INFORMATION_MESSAGE);
            ...
            JOptionPane.showMessageDialog(this,"Enter a non-zero number.","Value cannot be zero:",JOptionPane.INFORMATION_MESSAGE);
    ...
    private void saveButtonPressed() {
        if(isDataValid()){
            ...
            try{
                Object acc=clDB.queryOneElement(ClientAccountDB.accnum,"WHERE "+ClientAccountDB.name+"='"+obj.getAccNum()+"'");
                obj.setAccNum(acc);
            }catch(Exception e){
                System.out.println(e);
            }
            if(pnlBulkOrder.isVisible()){
                ...
                JOptionPane.showMessageDialog(this,"Bulk data enterd by you has been saved.","Saved successfully:",JOptionPane.INFORMATION_MESSAGE);
            } else
    ...
    private void saveChangeButtonPressed() {
        if(isDataValid()){
            dailyOrderBookController.modifyRecord(this, getValuesFromInput(),consNum);
            //resetFields();
        }
    }
    ...
    private void setFieldsToModify(DailyOrderBookObject dlObj){
        ...
        try{
            clientName=clAccDb.queryOneElement(ClientAccountDB.name,"WHERE "+ClientAccountDB.accnum+"='"+dlObj.getAccNum()+"'");
        }catch(Exception e){
        }
    ...
    private void deleteButtonPressed(){
        if(txtConsignmentNum.getText().trim().equals("")){
            JOptionPane.showMessageDialog(this,"Select a recprd to delete.","No record selected",JOptionPane.INFORMATION_MESSAGE);
            return ;
        }
        int opt = JOptionPane.showConfirmDialog(this,"You are about to delete a record permanently. Are you sure?","Confirm delete",JOptionPane.YES_NO_OPTION);
        if(opt==JOptionPane.YES_OPTION){//user chooses to delete
            if(dailyOrderBookController.deleteRecord(consNum))
                ...
                JOptionPane.showMessageDialog(this,"Record could not be deleted: enter proper search criteria","No record found corresponding your search criteria",JOptionPane.ERROR_MESSAGE);
        }
    }
    
    private void  showPriceList(){
        int weight=1000*Integer.parseInt(txtWeightKg.getText())+Integer.parseInt(txtWeightGm.getText());
    ...
    private void searchByConsignmentNum() {
        ...
        pnlSearchByClientName.setVisible(false);
        //fill cbInvoiceNum
        Object[] obj = dailyOrderBookController.getConsignmentNums(txtFromDate.getText(),txtToDate.getText());
    ...
    private void searchByClientNames() {
        ...
        //fill cbClientName
        Object[] obj1 = dailyOrderBookController.getClientNames(txtFromDate.getText(),txtToDate.getText());
    ...
    private void displayRecordFromList(String consignmentNum) {
        DailyOrderBookObject obj=dailyOrderBookController.getDailyOrderBookRecord(consignmentNum);
    ...
    /**
     *it holds the consignment no. for modificatiom: in modify mode,
     *u can modify the consignment no. but need the old value to update the record
     */
