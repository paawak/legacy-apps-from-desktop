 ...
 * SearchPanel.java
 *
 * Created on April 11, 2003, 1:48 PM
 */
...
public class SearchPanel extends javax.swing.JPanel {
     ...
     *
     *1> int TableRows: no. rows present in the parent table
     *2> Object[][] TableData: The entire data present in the table
     *3> javax.swing.JTable Table: The parent table whose elements are to be searched
     *4>String[] SearchOptions: The no. of columns of the table to be searched- these elements are added in the "Search"JComboBox
     *
     */
    public SearchPanel(int TableRows,Object[][] TableData,JTable Table,String[] SearchOptions) {
...
public void search(){
    ...
    if( SearchOptions[0].equals( cbSearch.getSelectedItem() ) )
            ...
            sortStrings(TableData,TableRows,1); 
