...
public class DiscountMasterPanel extends javax.swing.JPanel {

    /** Creates new form DiscountMaster201 */
    public DiscountMasterPanel() {
        initComponents();
    }
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        lblFormHeadingH.setText("Discount Master");
        ...
        jLabel41.setText("Discount Percentage");
        ...
        lblFormHeadingH1.setText("Discount Master");
...
if(sb.length()>30){
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
     try{
            accessDB();
            String ss = "SELECT * FROM SemaPhores WHERE TableName = 'DiscountMaster'";
            
            ResultSet res = stat.executeQuery(ss);
            
            if(!res.next()){
                String ss1="Insert into SemaPhores (TableName,CtrName,MaxCtr) values('"+tableName+"','DM_',1)";
...
txtCode.setText(""+tableShown[selrow][0]);
...
private void addSavePressed(){
        ...
        try{ 
            ...
            JOptionPane.showMessageDialog(this,"                   Enter a valid number.                              ","Error: Invalid data in Percentage field.",JOptionPane.ERROR_MESSAGE);
                      txtBaseCur.setText("0");
...
if(name.equals("")){
         JOptionPane.showMessageDialog(this," The Name-field is empty  ","Error!",JOptionPane.ERROR_MESSAGE);
            ...
            JOptionPane.showMessageDialog(this," Percentage cannot be zero.  ","Error!",JOptionPane.ERROR_MESSAGE);
          txtBaseCur.setText("0");
          txtBaseCur.requestFocus();
        }//end else if
        else if( baseCur > 100  ){
            JOptionPane.showMessageDialog(this," Percentage cannot be more than 100%.  ","Error!",JOptionPane.ERROR_MESSAGE);
          txtBaseCur.setText("0");
          txtBaseCur.requestFocus();
        }//end else if        
        else if(baseCur<0){
JOptionPane.showMessageDialog(this,"                         Enter a positive number.                       ","Error: Invalid data in Percentage field.",JOptionPane.ERROR_MESSAGE);                    
txtBaseCur.setText("");
txtBaseCur.requestFocus();
        }
...
private void updateCode() {
    try{
        accessDB();
        ctr++;
        String ss1 = "UPDATE SemaPhores SET  MaxCtr = "+ctr+" WHERE TableName = 'DiscountMaster' ";
        stat.executeUpdate(ss1);
...
Connection con;
float baseCur = 0;
String tableName="DiscountMaster",dbParam[],ss,ss1="",ss2="";    

String tableColHeadsShown[]={"Code","Name","Percentage","Active"};    
