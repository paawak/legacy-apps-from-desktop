...
public class UnitMasterPanel extends javax.swing.JPanel {

    /** Creates new form UnitMaster201 */
    public UnitMasterPanel() {
        initComponents();
    }
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        lblFormHeadingH.setText("Unit  Master");
        ...
        lblFormHeadingH1.setText("Unit  Master");
...
if(sb.length()>30){
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
     try{
            accessDB();
            String ss = "SELECT * FROM SemaPhores WHERE TableName = 'UnitMaster'";
            
            ResultSet res = stat.executeQuery(ss);
            
            if(!res.next()){
                String ss1="Insert into SemaPhores (TableName,CtrName,MaxCtr) values('"+tableName+"','UNM_',1)";
...
private void updateCode() {
    try{
        accessDB();
        ctr++;
        String ss1 = "UPDATE SemaPhores SET  MaxCtr = "+ctr+" WHERE TableName = 'UnitMaster' ";
        stat.executeUpdate(ss1);
...
String tableName="UnitMaster",dbParam[],ss,ss1="",ss2="";    
