...
import usefulClasses.generalUtilities.HandleError;
...
public class LinkDB extends javax.swing.JFrame {
    ...
    private void accessDB() {
        try {
            ...
            // "jdbc:mysql://localhost/neoinventory?user=root&password=agnimitra"
            // );
            con = DriverManager.getConnection(CONN);
            stat = con.createStatement();
        }// end try
        catch (Exception e) {
            err.displayError("class LinkDB, methd. accessDB() from table "
                    + tableName, e);
        }// end catch
    }
    ...
    public void getAllColNames() {
        try {
            ...
            err.displayError(
                    "class LinkDB, methd. getAllColNames() from table "
                            + tableName, e);
        }// end catch
    ...
    public String addData(int[] colNos, Object[] val) {// whereClause can be an
        ...
        if (colNos.length != val.length)
            JOptionPane.showMessageDialog(this,
                    " Value-List not matching with the no. of Columns.\nNo. of columns = "
                            + colNos.length
                            + "\tNo. of values to be inserted = " + val.length
                            + ": Make sure that they are equal.",
                    "Error in the addData method of LinkDB class using Database Table "
            ...
            try {
                ...
                err.displayError("class LinkDB, methd. addData() from table "
                        + tableName, e);
            }// end catch

            ss = "INSERT INTO  " + tableName + " (" + names + ") VALUES "
                    + " (" + values + ") ";
        }// end main else
        return ss;
        ...
        if (no_of_cols - 1 != val.length)
            JOptionPane
                    .showMessageDialog(
                            this,
                            " Value-List not matching with the no. of Columns.\nNo. of columns = "
                                    + (allColNames.length - 2)
                                    + "\tNo. of values to be inserted = "
                                    + val.length
                                    + ": Make sure that they are equal.",
                            "Error in the addDataAllColsBut1st() method of LinkDB class using Database Table "
                                    + tableName + ":",
            ...
            try {
                ...
                err.displayError(
                        "class LinkDB, methd. addDataAllColsBut1st() from table "
                                + tableName, e);
            }// end catch
    ...
    public String modifyData(String[] col_Names, Object[] val,
            String whereClause) {
            ...
            JOptionPane
                    .showMessageDialog(
                            ...
                            " Value-List not matching with the no. of Columns.\nNo. of columns = "
                                    ...
                                    + val.length
                                    + ": Make sure that they are equal.",
                            "Error in the modifyDataAllColsBut1st() method of LinkDB class using Database Table "
                                    + tableName + ":",
                            JOptionPane.ERROR_MESSAGE);
        else {// main else
    ...
    public void fillCombo(javax.swing.JComboBox comboName, String colName,
            String whereClause, String orderBy) {
        try {
            accessDB();
            String ss = "SELECT " + colName + " FROM " + tableName + " "
            ...
            err.displayError("class LinkDB, methd. fillCombo(), combo name:"
                    + comboName + ", Database Table: " + tableName, e);
        }// end catch
    }// end fillCombo

    public void fillCombo(javax.swing.JComboBox comboName, String colName1,
            String appendMiddle, String colName2, String appendEnd,
            String whereClause, String orderBy) {
        try {
            accessDB();
            String ss = "SELECT " + colName1 + "," + colName2 + " FROM "
                    + tableName + " " + whereClause + " ORDER BY " + orderBy;
            ResultSet res = stat.executeQuery(ss);
            while (res.next())
                comboName.addItem(res.getString(1).trim() + appendMiddle
                        + res.getString(2).trim() + appendEnd);
            con.close();
        }// end try
        catch (Exception e) {
            err.displayError("class LinkDB, methd. fillCombo(), combo name:"
    ...
    public int queryRow(String whereClause) {
        ...
        try {
            ...
            try {
                ...
                err.displayError(
                        "class LinkDB, methd. queryRow(), Database Table: "
                                + tableName, e);
            }// end catch
    ...
    public Object queryOneEle(String colName, String whereClause) {
        ...
        try {
            ...
            err.displayError(
                    "class LinkDB, methd. queryOneEle(), Database Table: "
                            + tableName, e);
        }// end catch
    ...
    public Object queryOneEle(int colNo, String whereClause) {
        ...
        try {
            ...
            String ss = "SELECT " + allColNames[colNo] + "  FROM " + tableName
                    + " " + whereClause;
    ...
    public Object[] query1Col(int row, int colNo, boolean distinct,
            String whereClause) {
        ...
        String ss = "";
        if (distinct)
            ss = "SELECT DISTINCT " + allColNames[colNo] + "  FROM "
                    + tableName + " " + whereClause;
        else
            ss = "SELECT " + allColNames[colNo] + "  FROM " + tableName + " "
                    + whereClause;
        ...
        try {
            ...
            err.displayError(
                    "class LinkDB, methd. query1Col(), Database Table: "
                            + tableName, e);
        }// end catch
    ...
    public Object[] query1Col(int row, String colName, boolean distinct,
            String whereClause) {
        ...
        String ss = "";
        if (distinct)
            ss = "SELECT DISTINCT " + colName + "  FROM " + tableName + " "
                    + whereClause;
        else
            ss = "SELECT " + colName + "  FROM " + tableName + " "
                    + whereClause;
    ...
    public Object[][] queryMulCols(int rows, int colNos[], String whereClause) {
        ...
        try {
            accessDB();
            String ss = "SELECT " + names + "  FROM " + tableName + " "
                    + whereClause;
            ...
            err.displayError(
                    "class LinkDB, methd. queryMulCols(), Database Table: "
                            + tableName, e);
        }// end catch
    ...
    public Object[][] queryMulCols(int rows, String[] colNames,
            String whereClause) {
    ...
    public Object[] queryMulEle(String[] colNames, String whereClause) {
        ...
        try {
            ...
            err.displayError(
                    "class LinkDB, methd. queryMulEle(), Database Table: "
                            + tableName, e);
        }// end catch
    ...
    public Object[][] queryAllColsBut1st(int rows, String whereClause) {
        ...
        try {
            ...
            err.displayError(
                    "class LinkDB, methd. queryAllColsBut1st(), Database Table: "
                            + tableName, e);
        }// end catch
        ...
        if (row == 0) {
            JOptionPane
                    .showMessageDialog(
                            ...
                            " Table "
                                    + tableName
                                    + " in the Database has no entry.\n Make suitable entries in the Table to run this Form.  ",
                            "From Database:", JOptionPane.INFORMATION_MESSAGE);
        }// end if
    }// end checkEmpty
