...
public class PaymodeMasterPanel extends javax.swing.JPanel {

    /** Creates new form PaymodeMaster201 */
    public PaymodeMasterPanel() {
        initComponents();
    }
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        lblFormHeadingH.setText("Paymode Master");
        ...
        btAddSave.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                btAddSaveKeyPressed(evt);
            }
        });
        ...
        lblFormHeadingH1.setText("Paymode Master");
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
     try{
            accessDB();
            String ss = "SELECT * FROM SemaPhores WHERE TableName = 'PaymodeMaster'";
            
            ResultSet res = stat.executeQuery(ss);
            
            if(!res.next()){
                String ss1="Insert into SemaPhores (TableName,CtrName,MaxCtr) values('"+tableName+"','PM_',1)";
...
jScrollPane1.setSize(500,h+5);  
 ...
 // Add your handling code here:
    ...
    private void btAddSaveKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_btAddSaveKeyPressed
if(controlKey){
...
controlKey=false;
    }//GEN-LAST:event_btAddSaveKeyPressed
...
private void updateCode() {
    try{
        accessDB();
        ctr++;
        String ss1 = "UPDATE SemaPhores SET  MaxCtr = "+ctr+" WHERE TableName = 'PaymodeMaster' ";
        stat.executeUpdate(ss1);
...
String tableName="PaymodeMaster",dbParam[],ss,ss1="",ss2="";    
