...
public class CashLocMasterPanel extends javax.swing.JPanel {
    ...
    /** Creates new form CashLocMaster201 */
    public CashLocMasterPanel() {
        initComponents();
    }
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        lblFormHeadingH.setText("Cash Location Master");
        pnlHome.add(lblFormHeadingH, new org.netbeans.lib.awtextra.AbsoluteConstraints(205, 20, 290, -1));
        ...
        lblFormHeadingH1.setText("Cash Location Master");
        pnlAddMod.add(lblFormHeadingH1, new org.netbeans.lib.awtextra.AbsoluteConstraints(205, 20, 290, -1));
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
     try{
            accessDB();
            String ss = "SELECT * FROM SemaPhores WHERE TableName = 'CashLocMaster'";
            
            ResultSet res = stat.executeQuery(ss);
            
            if(!res.next()){
                String ss1="Insert into SemaPhores (TableName,CtrName,MaxCtr) values('"+tableName+"','CLM_',1)";
...
private void updateCode() {
    try{
        accessDB();
        ctr++;
        String ss1 = "UPDATE SemaPhores SET  MaxCtr = "+ctr+" WHERE TableName = 'CashLocMaster' ";
        stat.executeUpdate(ss1);
...
String tableName="CashLocMaster",dbParam[],ss,ss1="",ss2="";    
