...
public class LocationMasterPanel extends javax.swing.JPanel {
    /** Creates new form LocationMaster201 */
    public LocationMasterPanel() {
        initComponents();
    }
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        lblFormHeadingH.setText("Location Master");
        ...
        lblFormHeadingH1.setText("Location Master");
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
     try{
            accessDB();
            String ss = "SELECT * FROM SemaPhores WHERE TableName = 'LocMaster'";
            
            ResultSet res = stat.executeQuery(ss);
            
            if(!res.next()){
                String ss1="Insert into SemaPhores (TableName,CtrName,MaxCtr) values('"+tableName+"','LM_',1)";
...
private void updateCode() {
    try{
        accessDB();
        ctr++;
        String ss1 = "UPDATE SemaPhores SET  MaxCtr = "+ctr+" WHERE TableName = 'LocMaster' ";
        stat.executeUpdate(ss1);
...
String tableName="LocMaster",dbParam[],ss,ss1="",ss2="";    
