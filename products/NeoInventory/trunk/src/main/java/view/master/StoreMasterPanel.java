...
public class StoreMasterPanel extends javax.swing.JPanel{

    /** Creates new form StoreMaster201 */
    public StoreMasterPanel() {
        
     try{
            accessDB();
            String ss = "SELECT * FROM SemaPhores WHERE TableName = 'StoreMaster'";
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        lblFormHeadingH.setText("Store Master");
        ...
        add(pnlHome, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 750, 500));
        ...
        lblFormHeadingH1.setText("Store Master");
        pnlAddMod.add(lblFormHeadingH1, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 20, 200, -1));

        add(pnlAddMod, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 750, 500));
...
tableShown=tableY;
      ...
      JOptionPane.showMessageDialog(this," The Database contains no Active Data. ","Sorry!",JOptionPane.INFORMATION_MESSAGE);    
      rdbtAllData.requestFocus();
rdbtAllDataSelected();
...
tableShown=tableN;
      ...
      JOptionPane.showMessageDialog(this," The Database contains no Inactive Data. ","Sorry!",JOptionPane.INFORMATION_MESSAGE);    
      rdbtAllData.requestFocus();
rdbtAllDataSelected();
...
jScrollPane1.setSize(500,h+5);
    ...
    /**
     *
     *Conviniebce method to add new data to the table StoreMaster and simultaneously create a new 
     *table Store_[Store_ID of the new table].
     *
     */
...
/**
 *Note : In MS-Access, the Commit/Rollback is done by:
 *   try{
 *    con.setAutoCommit(false);
 *    stat.executeUpdate("SQL-Statement1");  
 *    stat.execute("SQL-Statement2");
 *    con.commit(); 
 *    con.close();  
 *        }
 ...
 */        
    ...
    String ss1 = "CREATE TABLE Store_"+code
    +" ("
    +"StoreID VARCHAR(10) NOT NULL DEFAULT '"+code+"', ItemNo VARCHAR(10) NOT NULL,OpeningStock INT(11) NOT NULL,"
    +"Reciepts INT(11) NOT NULL,Issues INT(11) NOT NULL,BatchNo VARCHAR(10) NOT NULL,"
    +"ExpiryDate VARCHAR(10) NOT NULL,LoosePerPack INT(11) NOT NULL,PackperBulk INT(11) NOT NULL,"
    ...
    /**
     *In MySQL, the following lines of codes are used for COMMIT/ROLLBACK:
     *try{
     *      stat.execute("BEGIN");//or
     ...
     *
     *
     *NOTE: This is only for safe-transaction tables.
     */
...
JOptionPane.showMessageDialog(this," The Database currently has no active data.","Sorry!",JOptionPane.INFORMATION_MESSAGE); 
else if(  rowTotal==rowY && rdbtNData.isSelected() )
JOptionPane.showMessageDialog(this," The Database currently contains no inactive data.","Sorry!",JOptionPane.INFORMATION_MESSAGE); 
else if(click && tableShown[selrow][3].equals("N"))
JOptionPane.showMessageDialog(this," Cannot modify Inactive data: Activate it first.","Sorry!",JOptionPane.INFORMATION_MESSAGE); 
else if( click ){
...
click=false;
      ...
      JOptionPane.showMessageDialog(this," Select the Item you want to modify from the Table.","No Item Selected!",JOptionPane.INFORMATION_MESSAGE); 
     tblDB.clearSelection();   
...
JOptionPane.showMessageDialog(this," The Database currently contains no inactive data.","Sorry!",JOptionPane.INFORMATION_MESSAGE); 
      ...
      JOptionPane.showMessageDialog(this," Select the Item you want to modify from the Table. ","No Items selected!",JOptionPane.INFORMATION_MESSAGE); 
        else if (click){
          tblDB.setRowSelectionAllowed(true);   
if(selrow>=0){
    if(activate){
        if(tableShown[selrow][3].equals("Y"))
JOptionPane.showMessageDialog(this," Selected item is already Active!","",JOptionPane.INFORMATION_MESSAGE); 
        else{//inner else  
...
JOptionPane.showMessageDialog(this," Selected item is already Inactive!","",JOptionPane.INFORMATION_MESSAGE); 
        else {//inner else   
...
if(name.equals("")){
         JOptionPane.showMessageDialog(this," The Name-field is empty  ","Error!",JOptionPane.INFORMATION_MESSAGE);
                   txtName.setText("");
                   txtName.requestFocus();
          
   }//end if
                        else if(remarks.equals("")){
         JOptionPane.showMessageDialog(this," The Remarks-field is empty  ","Error!",JOptionPane.INFORMATION_MESSAGE);
          txtRemarks.setText("");
          txtRemarks.requestFocus();
                        }//end else if
  
else if(duplicate && add){
    JOptionPane.showMessageDialog(this," This name already exists: enter an unique name.","Error!",JOptionPane.INFORMATION_MESSAGE);
          txtName.setText("");
          txtName.requestFocus();
...
private void updateCode() {
    try{
        accessDB();
        ctr++;
        String ss1 = "UPDATE SemaPhores SET  MaxCtr = "+ctr+" WHERE TableName = 'StoreMaster' ";
        stat.executeUpdate(ss1);
...
String tableName="StoreMaster",dbParam[],ss,ss1="",ss2="";    
