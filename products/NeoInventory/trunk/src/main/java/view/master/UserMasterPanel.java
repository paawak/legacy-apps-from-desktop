...
public class UserMasterPanel extends javax.swing.JPanel {

    /** Creates new form UserMaster201 */
    public UserMasterPanel() {
        initComponents();
    }
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        lblFormHeadingH.setText("User Master");
        ...
        lblFormHeadingH1.setText("User Master");
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
     try{
            accessDB();
            String ss = "SELECT * FROM SemaPhores WHERE TableName = 'UserMaster'";
            
            ResultSet res = stat.executeQuery(ss);
            
            if(!res.next()){
                String ss1="Insert into SemaPhores (TableName,CtrName,MaxCtr) values('"+tableName+"','PO_',1)";
...
private void updateCode() {
    try{
        accessDB();
        ctr++;
        String ss1 = "UPDATE SemaPhores SET  MaxCtr = "+ctr+" WHERE TableName = 'UserMaster' ";
        stat.executeUpdate(ss1);
...
String tableName="UserMaster",dbParam[],ss,ss1="",ss2="";    
